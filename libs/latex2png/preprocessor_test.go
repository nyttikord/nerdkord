...
func TestPreprocess(t *testing.T) {
	...
	res, err := Preprocess("", &PreprocessingOptions{TemplateFile: "../../config/default.tex"})
	...
	_, err = Preprocess("\\documentclass {article}", &PreprocessingOptions{TemplateFile: "../../config/default.tex"})
